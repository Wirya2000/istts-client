...
export default function LaporanBeasiswa({kodeBeasiswa}) {
    // const theme = useTheme();
    ...
    const handleOnExport = () => {
      ...
      XLSX.writeFile(wb, `laporan_beasiswa.xlsx`)
    };
    ...
    const handleOnPDF = () => {
      ...
      doc.autoTable({
        head: [['Jenis Beasiswa', 'Periode', 'Waktu Pendaftaran', 'No SK', 'NRP', 'Nama Mahasiswa', 'IPK']],

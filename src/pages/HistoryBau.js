...
export default function HistoryBau({kodeBeasiswa}) {
    // const theme = useTheme();
    ...
    const getPeriode = async() => {
      ...
      await axios.get(`${process.env.REACT_APP_BACKEND_URL}/master/periodebau`,
      {
          headers: {
    ...
    const getBeasiswa = async() => {
      ...
      console.log("sukses masuk");
      const token = Cookies.get('myToken');
      await axios.get(`${process.env.REACT_APP_BACKEND_URL}/beaapply/dana/${periodeKode}`,
      {
          headers: {
          Authorization: `Bearer ${token}`,
          }
                ...
                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                  ...
                  />
                    ...
                    : beasiswa
                      ...
                      const isItemSelected = isSelected(beasiswa.bea_jenis_nama);
                      ...
                      return (
                        ...
                        >
                            ...
                            <TableCell
                              ...
                              align='center'
                            >
                              {beasiswa.bea_jenis_nama}
                            </TableCell>
                            <TableCell align="left">{beasiswa.mhs_nrp}<br/>{beasiswa.mhs_nama}</TableCell>
                            ...
                            {/* {(() => {
                                ...
                                // let jumdana = 0;
                                // if (Array.isArray(beasiswa && beasiswa.beaapply)) {
                                //     beasiswa && beasiswa.beaapply.map(item => {
                                //         jumdana += (parseInt(item.bea_apply_spp, 10) + parseInt(item.bea_apply_sks, 10));
                                //     });
                                //     return jumdana
                                // }
                                // return jumdana // Return the calculated value
                                // const isibeaapply = beasiswa.beaapply;
                                // let jumdana = 0;
                                // for (let i = 0; i < isibeaapply.length; i+=1) {
                                //   // const element = array[i];
                                //     jumdana += (parseInt(isibeaapply[i].bea_apply_spp, 10) + parseInt(isibeaapply[i].bea_apply_sks, 10));
                                // }
                                // return jumdana
                            })()} */}
                            {formatCurrency.format((parseInt(beasiswa.bea_apply_spp, 10)*parseInt(beasiswa.nom_spp[0], 10))+(parseInt(beasiswa.bea_apply_sks, 10)*parseInt(beasiswa.nom_sks[0], 10)))}
                            {/* {(parseInt(beasiswa.bea_apply_spp, 10)*parseInt(beasiswa.nom_spp[0], 10))} */}
                            </TableCell>
                        </TableRow>

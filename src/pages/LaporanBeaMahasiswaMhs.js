...
export default function LaporanBeaMahasiswaMhs() {
    // const theme = useTheme();
    ...
    const getBeaApply = async() => {
      console.log("sukses masuk");
      const token = Cookies.get("myToken");
      console.log(`${process.env.REACT_APP_BACKEND_URL}/laporan/beamhs`);
      await axios.get(`${process.env.REACT_APP_BACKEND_URL}/laporan/beamhs`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        }
